var jsPsychHtmlButtonResponse = (function (jspsych) {
  ...
  class HtmlButtonResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          html += '<div id="jspsych-html-button-response-btngroup" style="display: flex; justify-content: center;">';
          for (var i = 0; i < trial.choices.length; i++) {
    ...
    //for (var i = 0; i < trial.choices.length; i++) {
    //    var str = buttons[i].replace(/%choice%/g, trial.choices[i]);
    //    html += `<div id="jspsych-html-button-response-button-${i}"
    //    data-choice="${i}" style="width:10%;height:10%;text-align:center">`
    //    html += str
    //    html += '</div>'
    //}
    //html += '</div>';
